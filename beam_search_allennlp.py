...
class BeamSearch:
    ...
    def search(
        ...
        #     )
        #print("The shape of the predictions is: ", predictions[0].shape)
        for timestep in range(self.max_steps - 1):
            ...
            #print(torch.allclose(class_log_probabilities[0], class_log_probabilities[1]))
            ...
            #print("Expanded: ", torch.allclose(last_predictions_expanded[0], last_predictions_expanded[1]))
