...
class BahdanauAttention(nn.Module):
	...
	def __init__(self, key_size, query_size):
        ...
        self.key_layer = nn.Linear(key_size, query_size, bias=False)

        # The query is the previous state of the cell, as in the Bahdanau Paper, we will need a weight matrix to project it
        self.query_layer = nn.Linear(query_size, query_size, bias=False)
        ...
        self.energy_layer = nn.Linear(query_sizes, 1, bias=False)
