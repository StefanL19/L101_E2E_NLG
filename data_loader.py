...
def generate_nmt_batches(dataset, batch_size, shuffle=True, 
    ...
    for data_dict in dataloader:
        ...
        # Maybe needed for pad sequences
        ...
        for name, tensor in data_dict.items():
            if name not in ["ref_gt", "inp_gt"]:
                ...
                # A specific trick to preserve the order for the ground truth reference and input sentences
                out_data_dict[name] = np.array(data_dict[name])[sorted_length_indices]
