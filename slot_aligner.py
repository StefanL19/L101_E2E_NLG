...
class SlotAligner(object):
    ...
    def align_name(self, inp):
        pass

    def align_near(self, inp):
        pass

    def align_eattype(self, inp):
    ...
    def align_pricerange(self, ref_text, ref_text_tokenized, value):
        #Using the soft aligner
        pos = scalar_slots.align_scalar_slot(ref_text, ref_text_tokenized, "pricerange", value, slot_stem_only=True)

    def align_customer_rating(self, ref_text, ref_text_tokenized, value):
    ...
    def align_area(self, ref_text, ref_text_tokenized, value):
    ...
    def align_familyfriendly(self, ref_text, ref_text_tokenized, value):
