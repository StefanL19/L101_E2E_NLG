...
args = Namespace(dataset_csv="data/inp_and_gt_name_near_food_no_inform.csv",
                 vectorizer_file="sparsity_test_no_inform_sparsemax_renyi_0.3_energy.json",
                 model_state_file="sparsity_test_no_inform_sparsemax_renyi_0.3_energy.pth",
...
with open("training_monitor.txt", "a") as f:
            f.write("Bahdanau Attention, Sparsemax, 48, 48, 256, no inform, softmax, energy loss Renyi 0.3")
            f.write("\n")
